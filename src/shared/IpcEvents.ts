...
export const enum IpcEvents {
    ...
    CHOOSE_ALL_TRAY_ASSETS = "VCD_CHOOSE_ALL_TRAY_ASSETS",
    SELECT_WINDOW_ICON = "VCD_SELECT_WINDOW_ICON",
    SELECT_SPLASH_HTML = "VCD_SELECT_SPLASH_HTML",

    GET_PLATFORM_SPOOF_INFO = "VCD_GET_PLATFORM_SPOOF_INFO",

    SET_STATIC_TITLE = "VCD_SET_STATIC_TITLE"
}
